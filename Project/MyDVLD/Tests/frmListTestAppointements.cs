...
{
	public partial class frmListTestAppointements : Form
	{
		private DataTable _dtLicenseTestAppointments;
		private int _LocalDrivingLicenseApplicationID;
		private clsTestType.enTestType _TestType = clsTestType.enTestType.VisionTest;

		public frmListTestAppointements(int LocalDrivingLicenseApplicationID, clsTestType.enTestType TestType)
		{
			InitializeComponent();
		...
		private void frmListTestAppointements_Load(object sender, EventArgs e)
		{
		...
		private void btnAddNewAppointment_Click(object sender, EventArgs e)
		{
			...
			if (LastTest == null)
			{
				...
				frm1.ShowDialog();
				frmListTestAppointements_Load(null, null);
				return;
			}
