...
namespace MyDVLD
{
	public partial class frmMain : Form
	{
		...
		{
			frmReplacelLostOrDamagedLicenseApplication frm = new frmReplacelLostOrDamagedLicenseApplication();
			frm.ShowDialog();
		}
